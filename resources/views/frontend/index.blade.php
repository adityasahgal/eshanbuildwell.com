    ...
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-12 col-md-6 col-lg-4">
                <div class="svc-card">
                    <div class="svc-img-wrap"><img src="{{ asset('assets/images/s1.jpeg') }}"
                    ...
                    <div class="svc-body">
                        ...
                        </ul><a href="https://wa.me/919015444490?text=Hi%20I%20want%20to%20book%20a%20consultation"
                            target="_blank" class="btn-read">Get in touch</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
                <div class="svc-card">
                    <div class="svc-img-wrap"><img src="{{ asset('assets/images/s2.jpeg') }}"
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="svc-card">
                    <div class="svc-img-wrap"><img src="{{ asset('assets/images/s3.jpeg') }}" alt="PMC" /><span
