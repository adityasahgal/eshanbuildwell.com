            ...
            <div class="row g-5">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="footer-item">
                        <p class="text-white-50 mb-3">{{ $genSetting['description'] }}</p>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="footer-item">
                        ...
                        <a href="{{ url('about-us') }}" class="text-white-50 d-block mb-2"><i
                                class="fas fa-angle-right me-2"></i>
                            About Us</a>
                        <!-- <a href="{{ url('gallery') }}" class="text-white-50 d-block mb-2"><i
                                class="fas fa-angle-right me-2"></i>
                            Gallery</a> -->
                        <a href="{{ url('blog') }}" class="text-white-50 d-block mb-2"><i
                                class="fas fa-angle-right me-2"></i>
                            Blog</a>
                        <a href="{{ url('contact-us') }}" class="text-white-50 d-block mb-2"><i
                                class="fas fa-angle-right me-2"></i>
                            Contact Us</a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="footer-item">
                        ...
                        <!-- <a href="{{ url('/') }}" class="text-white-50 d-block mb-2"><i
