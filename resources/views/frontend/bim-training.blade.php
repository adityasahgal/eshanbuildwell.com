...
$meta_description = "Join Eshan Buildwell's industry-focused BIM Training Program. Master Autodesk Revit, Navisworks, BIM coordination, and clash detection from real project experts. Certification provided. Enroll now!";
$keywords = "BIM Training, Revit Training, Navisworks Course, Building Information Modeling, BIM Coordination, Construction Technology Training, Eshan Buildwell Training, Delhi NCR BIM Course";
@endphp
...
.enroll-detail:last-child { border: none; }
...
.enroll-detail-txt .lbl { font-size: 0.75rem; color: rgba(255,255,255,0.6); }
.enroll-detail-txt .val { font-weight: 600; font-size: 1rem; color: #fff; }
...
.faq-box.open { border-color: var(--orange); box-shadow: var(--shadow-sm); }
.faq-btn {
    width: 100%; padding: 1.2rem 1.5rem; border: none; background: none;
    text-align: left; font-weight: 700; color: var(--navy);
    display: flex; justify-content: space-between; align-items: center;
    font-size: 1.1rem; font-family: 'Barlow Condensed', sans-serif;
}
.faq-box i { color: var(--orange); transition: transform 0.3s; font-size: 1.1rem; }
.faq-box.open i { transform: rotate(45deg); }
.faq-ans { max-height: 0; overflow: hidden; transition: max-height 0.3s ease-out; }
.faq-ans-inner { padding: 0 1.5rem 1.2rem; font-size: 0.92rem; color: var(--muted); border-top: 1px solid var(--border); padding-top: 1rem; line-height: 1.7; }
.faq-box.open .faq-ans { max-height: 300px; }

@media (max-width: 991px) {
    .bim-enroll-sidebar { position: static; margin-top: 40px; }
}
</style>
            ...
            <div class="row align-items-center g-4">
                <div class="col-lg-7">
                    <div class="hero-content">
                        ...
                        <p>Master Building Information Modeling with Autodesk Revit, Navisworks & advanced BIM coordination. Industry-ready skills from project experts.</p>
                        ...
                        <div class="d-flex flex-wrap gap-3 mt-4">
                            <a href="{{ url('contact-us') }}" class="btn-est">Enroll Now <i class="bi bi-chevron-right"></i></a>
                        ...
                        <div class="row g-4">
                            <div class="col-6">
                                <div class="text-center">
                                    <div class="h2 fw-bold mb-0" style="color:var(--orange); font-family:'Barlow Condensed'">500+</div>
                                    <div class="small text-white-50">Students Trained</div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="text-center">
                                    <div class="h2 fw-bold mb-0" style="color:var(--orange); font-family:'Barlow Condensed'">95%</div>
                                    <div class="small text-white-50">Placement Rate</div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="text-center">
                                    <div class="h2 fw-bold mb-0" style="color:var(--orange); font-family:'Barlow Condensed'">03</div>
                                    <div class="small text-white-50">Months Duration</div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="text-center">
                                    <div class="h2 fw-bold mb-0" style="color:var(--orange); font-family:'Barlow Condensed'">Live</div>
    ...
    <div class="py-4 border-bottom bg-white">
        <div class="container">
            <div class="d-flex align-items-center justify-content-center flex-wrap gap-2 gap-md-4">
                <span style="color:var(--muted); font-size:0.8rem; text-transform:uppercase; letter-spacing:2px; font-weight:700; margin-right:5px;">Tools Covered:</span>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-12 col-lg-6">
                    ...
                    <p class="mb-4 text-muted">Building Information Modeling (BIM) is not just 3D modeling — it's a data-driven process that integrates planning, design, and construction for superior project delivery. It reduces errors, saves costs, and improves coordination between disciplines.</p>
                    <div class="row g-3">
                        <div class="col-sm-6">
                    ...
                    <div class="mt-4">
                        <a href="{{ url('contact-us') }}" class="btn-read">Enquire Now <i class="bi bi-arrow-right ms-2"></i></a>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="position-relative">
                        <img src="https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=800&q=80" alt="BIM Training" class="img-fluid rounded-4 shadow-lg">
                        <div class="position-absolute d-none d-md-block" style="bottom:-20px; left:-20px; background:#fff; padding:20px; border-radius:15px; box-shadow:var(--shadow-md); border:1px solid var(--border);">
                            <div class="text-center">
                                <div class="h3 fw-bold mb-0" style="color:var(--orange); font-family:'Barlow Condensed'">95%</div>
    ...
    <section class="py-5" style="background:var(--gray-bg)" id="curriculum">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <div class="sec-line center"><span class="sec-sub">Comprehensive modules designed for industry readiness</span></div>
            </div>
            <div class="row g-4 mt-2">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="module-card">
                        ...
                        <div class="module-duration" style="background:rgba(232,119,34,0.15)"><i class="bi bi-stars"></i> Bonus Module</div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-12">
                            <div class="whom-card">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted">Students and fresh graduates looking to upskill and secure high-paying BIM specialist roles in global firms.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="whom-card">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted">Engineers and architects wanting to transition from 2D drafting to modern, data-rich BIM workflows.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="whom-card">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted">Construction companies looking to train their teams on digital coordination and ISO 19650 standards.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-lg-5">
                    <div class="bim-enroll-sidebar">
                        <div class="enroll-card">
                            <span class="enroll-badge"><i class="bi bi-fire me-1"></i> Special Batch Starting Soon</span>
                            ...
                            <a href="{{ url('contact-us') }}" class="btn-enroll-now">Enquire & Enroll Now <i class="bi bi-arrow-right ms-2"></i></a>
                            
                            <div class="mt-4 text-center">
                                <small style="color:rgba(255,255,255,0.5)"><i class="bi bi-info-circle me-1"></i> Detailed syllabus sent upon enquiry</small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-9">
                    <div class="faq-box open" id="f1">
                        <button class="faq-btn" onclick="toggleT('f1')">Do I need prior BIM experience? <i class="bi bi-plus-lg"></i></button>
                        <div class="faq-ans"><div class="faq-ans-inner">No! We start from the absolute basics. However, a background in Civil Engineering, Architecture, or Mechanical Engineering is highly recommended for better understanding.</div></div>
                    </div>
                    <div class="faq-box" id="f2">
                        <button class="faq-btn" onclick="toggleT('f2')">Which software will be taught? <i class="bi bi-plus-lg"></i></button>
                        <div class="faq-ans"><div class="faq-ans-inner">The core focus is on Autodesk Revit (Architecture, Structural, and MEP disciplines) and Navisworks for coordination. We also cover BIM 360 and ISO 19650 documentation standards.</div></div>
                    </div>
                    <div class="faq-box" id="f3">
                        <button class="faq-btn" onclick="toggleT('f3')">Is there any placement assistance? <i class="bi bi-plus-lg"></i></button>
                        <div class="faq-ans"><div class="faq-ans-inner">Yes! We provide dedicated career support, including resume optimization for BIM roles, mock technical interviews, and connecting you with our network of industry partners.</div></div>
                    </div>
                    <div class="faq-box" id="f4">
                        <button class="faq-btn" onclick="toggleT('f4')">Are these live sessions or recorded? <i class="bi bi-plus-lg"></i></button>
                        <div class="faq-ans"><div class="faq-ans-inner">All our sessions are conducted LIVE by project experts. This ensures you can ask questions in real-time and get immediate feedback on your project work.</div></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="cta-strip">
        <div class="container">
            ...
            <div class="d-flex flex-wrap justify-content-center gap-3">
                <a href="{{ url('contact-us') }}" class="btn-cta-lg">Enquire Now <i class="bi bi-chevron-right ms-2"></i></a>
                <a href="tel:+918800000000" class="btn-cta-outline"><i class="bi bi-telephone-fill me-2"></i> Call for Details</a>
            </div>
        </div>
    </section>
